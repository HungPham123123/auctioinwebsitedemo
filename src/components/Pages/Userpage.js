        ...
        <div class="container container-user">
          ...
          <div class="user-select-header">
            ...
            <div class="Tab-Select">
              <div class="nav-tab">
                <span>
                  <a class="nav-link selected active" href="#profile" data-toggle="tab">My Profile</a>
                </span>
              </div>
              <span class="Select-line selected-MyProfile"></span>
              <div class="nav-tab">
                <span>
                  <a class="nav-link" href="#Inbox" data-toggle="tab">Inbox</a>
                </span>
              </div>
              <div class="nav-tab">
                <span>
            ...
            <div class="tab-content">
              <div class="tab-pane active" id="profile">
                <div class="container container-user">
                  <div class="row">
                    <div class="col-md-6" style={{ marginBottom: '80px' }}>
                      <div class="ad-header">
                        <h3>Acount Details</h3>
                      </div>
                      <div class="account-details-box" style={{ maxWidth: '575px' }}>
                      <div class="ad-content">
                        ...
                        <div class="ad-birthdate">
                          <label for="" >Date Of Birth</label>
                          <input type="date" name="" id="dayOfBirth"  placeholder="Date of birth"/>
                        </div>
                        <div class="ad-phone-number">
                          <label for="">Number</label>
                          <input type="text" name="" id="phone" style={{ width: '100%' }}  placeholder=""/>
                        </div>    
                        <div class="ad-email">
                          <label for="">Optional</label>
                          <input type="text" name="" id="Optional" style={{ width: '100%' }}  placeholder=""/>
                        </div>    
                      </div>
                      <div class="save-ad-box">
                    </div>
                    </div>
                    </div>
                    <div class="col-md-6">
                      <div class="bd-header">
                          <h3>Delivey and billing address</h3>
                      </div>
                      <div class="billing-delivery-address-box" style={{ maxWidth: '575px' }}>
                          <div class="bd-content">
                              <label for="">Billing address</label>
                              <div class="bd-first-name">
                                  <input type="text" name="billing_first_name" id="billing_first_name" placeholder="" />
                                  <span>First name</span>
                              </div>
                              <div class="bd-last-name">
                                  <input type="text" name="billing_last_name" id="billing_last_name" placeholder="" />
                                  <span>Last name</span>
                              </div>
                              <div class="bd-address">
                                  <input type="text" name="billing_address" id="billing_address" placeholder="" />
                                  <span>Address</span>
                              </div>
                              <div class="bd-address-details">
                                  <input class="zip-input" type="text" name="billing_zip" id="billing_zip" placeholder=""  style={{ width: '25%' }}/>
                                  <input class="city-input" type="text" name="billing_city" id="billing_city" placeholder=""  style={{ width: '70%' }}/>
                                  <span class="zip-span">ZIP code</span>
                                  <span class="city-span">City</span>
                              </div>
                              <div class="billing-address">
                                  <div class="bd-country">
                          ...
                          <div class="save-bd-box">
                            <button class="Save-bd" onclick="prepareAndSaveAddress()">Save</button>
                          </div>
                      </div>
                  </div>
                  </div>
              ...
              <div class="tab-pane" id="Orders">
                <div class="order-container">
                  <div class="container container-user">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="my-order-container" id="orders-container">
